...
public class ServerForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblServerStatus.setBackground(new java.awt.Color(204, 0, 204));
        lblServerStatus.setText("Server status");

        btnPokreniServer.setBackground(new java.awt.Color(153, 0, 153));
        ...
        btnUgasiServer.setBackground(new java.awt.Color(153, 0, 153));
        btnUgasiServer.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnUgasiServer.setForeground(new java.awt.Color(255, 255, 255));
